    ...
    <div id="container">
        ...
        <section>
            ...
            <main>
                ...
                <p class="hakYazi">
                <?php
                $yazi = mysqli_fetch_assoc( mysqli_query($con,"SELECT * FROM `contents` WHERE name='hak_biz_kimiz'"));       
                        echo $yazi['text'];
                ?>
                </p>
                <h3>Kurumsal</h3>
                ...
                <p class="hakYazi"><?php
                $yazi = mysqli_fetch_assoc( mysqli_query($con,"SELECT * FROM `contents` WHERE name='hak_kurumsal'"));       
                        echo $yazi['text'];
                ?></p>
                ...
                <h3>Vizyon&Misyon</h3>
                <p class="hakYazi"><?php
                $yazi = mysqli_fetch_assoc( mysqli_query($con,"SELECT * FROM `contents` WHERE name='hak_vizyon'"));       
                        echo $yazi['text'];
                ?></p>
